...
# ----------KLASIRANE 2022----------
@st.cache_data()
def klasirane_2022_combined_function():
    # Data import
    mesta_2022_3 = pd.read_csv('klasirane/2022/free_IIIetap_sait (7).csv', encoding='utf-8', encoding_errors='ignore')
    mesta_2022_4 = pd.read_csv('klasirane/2022/svobodni_mesta_sled_IIIetap_2022 (2).csv', encoding='utf-8', encoding_errors='ignore')
    klasirane_2022_1 = pd.read_csv('klasirane/2022/po_bal_sait (5).csv', encoding='utf-8', encoding_errors='ignore')
    klasirane_2022_2 = pd.read_csv('klasirane/2022/min_max_2_etap_2022 (5).csv', encoding='utf-8', encoding_errors='ignore')
    klasirane_2022_3 = pd.read_csv('klasirane/2022/min_max_III_etap (3).csv', encoding='utf-8', encoding_errors='ignore')
    kodove_2022 = pd.read_csv('klasirane/2022/Za_saita_s_kodove_i_baloobrazuvane_2022.csv', encoding='utf-8', encoding_errors='ignore')
    ...
    # print(result)
    return klasirane_2022_combined
