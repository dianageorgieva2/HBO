...
# ----------KLASIRANE 2020----------
# Data import
mesta_2020_3 = pd.read_csv('klasirane/2020/свободни-места-за-3-етап-2020_.csv')
mesta_2020_4 = pd.read_csv('klasirane/2020/Свободни-места-за-4-етап-2020.csv')
mesta_2020_5 = pd.read_csv('klasirane/2020/SVOBODNI_MESTA_08_09_2020.csv')
klasirane_2020_1 = pd.read_csv('klasirane/2020/min_max_1_etap.csv')
klasirane_2020_2 = pd.read_csv('klasirane/2020/min_maх_paralelki_2_etap-2020.csv')
klasirane_2020_3 = pd.read_csv('klasirane/2020/min_max_po_paralelki_3kl.csv')
kodove_2020 = pd.read_csv('klasirane/2020/Паралелки-кодове-2020_.csv')
...
klasirane_2020_1_clean = klasirane_2020_1_clean.groupby('Код паралелка', as_index=False).sum()
...
klasirane_2020_2_clean[['Мин_бал_о', 'Мин_бал_м', 'Мин_бал_ж', 'Макс_бал_о', 'Макс_бал_м', 'Макс_бал_ж']] = klasirane_2020_2_clean[['Мин_бал_о', 'Мин_бал_м', 'Мин_бал_ж', 'Макс_бал_о', 'Макс_бал_м', 'Макс_бал_ж']].\
    apply(pd.to_numeric, errors='coerce').astype("float")
klasirane_2020_2_clean = klasirane_2020_2_clean.groupby('Код паралелка', as_index=False).sum()
...
klasirane_2020_3_clean[['Мин_бал_о', 'Мин_бал_м', 'Мин_бал_ж', 'Макс_бал_о', 'Макс_бал_м', 'Макс_бал_ж']] = klasirane_2020_3_clean[['Мин_бал_о', 'Мин_бал_м', 'Мин_бал_ж', 'Макс_бал_о', 'Макс_бал_м', 'Макс_бал_ж']].\
    apply(pd.to_numeric, errors='coerce').astype("float")
klasirane_2020_3_clean = klasirane_2020_3_clean.groupby('Код паралелка', as_index=False).sum()
