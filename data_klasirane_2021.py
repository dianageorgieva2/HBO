...
# ----------KLASIRANE 2021----------
@st.cache_data()
def klasirane_2021_combined_function():
    # Data import
    mesta_2021_3 = pd.read_csv('klasirane/2021/Свободни_места_трети_етап-1.csv', encoding='utf-8', encoding_errors='ignore')
    mesta_2021_4 = pd.read_csv('klasirane/2021/svobodni_mesta_za_4_etap_2021.csv', encoding='utf-8', encoding_errors='ignore')
    mesta_2021_5 = pd.read_csv('klasirane/2021/Справка-свободни-места-към-03.09.21.csv', encoding='utf-8', encoding_errors='ignore')
    klasirane_2021_1 = pd.read_csv('klasirane/2021/За_СайтаСправка_за_мин_мак_по_паралелки_сорт_мин_3rtf (1).csv', encoding='utf-8', encoding_errors='ignore')
    klasirane_2021_2 = pd.read_csv('klasirane/2021/Spravka_min_max_par_2_klasirane_21_22.csv', encoding='utf-8', encoding_errors='ignore')
    klasirane_2021_3 = pd.read_csv('klasirane/2021/spravka_min_max_3_klasirane.csv', encoding='utf-8', encoding_errors='ignore')
    kodove_2021 = pd.read_csv('klasirane/2021/za_saita_s_kodove_22_06.csv', encoding='utf-8', encoding_errors='ignore')
    ...
    # print(result)
    return klasirane_2021_combined
